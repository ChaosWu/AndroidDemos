...
public class LoadImageAsync extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.thread_android_load_image_async);

		gridview = (GridView) findViewById(R.id.gv_image_async_gridview);
		...
		buttonReload = (Button) findViewById(R.id.bt_image_async_reload);
		buttonReload.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// mixed files
				myImageAdapter = new ImageAdapter(LoadImageAsync.this);
				gridview.setAdapter(myImageAdapter);
				myAsyncTaskLoadFiles = new AsyncTaskLoadFiles(myImageAdapter);
				myAsyncTaskLoadFiles.execute();
			}
