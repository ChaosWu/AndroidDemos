 ...
 * 
 */
public class BlueToothBeServer extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.other_bluetooth_be_connected);
		textInfo = (TextView) findViewById(R.id.bluetooth_be_connected_info);
		textStatus = (TextView) findViewById(R.id.bluetooth_be_connected_status);

		inputPane = (LinearLayout) findViewById(R.id.bluetooth_be_connected_inputpane);
		inputField = (EditText) findViewById(R.id.bluetooth_be_connected_input);
		btnSend = (Button) findViewById(R.id.bluetooth_be_connected_send);
		btnSend.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				if (myThreadConnected != null) {
					byte[] bytesToSend = inputField.getText().toString()
							.getBytes();
	...
	private class ThreadBeConnected extends Thread {
		...
		public ThreadBeConnected() {
			try {
				bluetoothServerSocket = bluetoothAdapter
						.listenUsingRfcommWithServiceRecord(myName, myUUID);
		...
		public void run() {
			...
			if (bluetoothServerSocket != null) {
				try {
					...
					BluetoothDevice remoteDevice = bluetoothSocket
							.getRemoteDevice();
		...
		public void cancel() {
			...
			Toast.makeText(getApplicationContext(),
					"close bluetoothServerSocket", Toast.LENGTH_LONG).show();
