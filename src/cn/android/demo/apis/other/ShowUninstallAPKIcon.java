 ...
 *
 */
public class ShowUninstallAPKIcon extends Activity {
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.other_show_uninstall_apk_icon);
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				showUninstallAPKIcon(str);
			}
		}).start();
		getUninatllApkInfo(this, Environment.getExternalStorageDirectory()
				+ "/CatchChat_9.apk");
	}
