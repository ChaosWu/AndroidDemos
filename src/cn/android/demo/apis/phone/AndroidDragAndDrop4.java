...
import cn.android.demo.apis.ui.widget.LinearLayoutListView;
...
/**
 * Drag Drop between listview
 * 
 * @author Elroy
 * 
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class AndroidDragAndDrop4 extends Activity {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (rowView == null) {
				LayoutInflater inflater = ((Activity) context)
						.getLayoutInflater();
				rowView = inflater.inflate(R.layout.list_image_row, null);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.phone_android_drag_drop4);
		listView1 = (ListView) findViewById(R.id.drag_drop_4_listview1);
		listView2 = (ListView) findViewById(R.id.drag_drop_4_listview2);
		listView3 = (ListView) findViewById(R.id.drag_drop_4_listview3);

		area1 = (LinearLayoutListView) findViewById(R.id.drag_drop_4_pane1);
		area2 = (LinearLayoutListView) findViewById(R.id.drag_drop_4_pane2);
		area3 = (LinearLayoutListView) findViewById(R.id.drag_drop_4_pane3);
		...
		prompt = (TextView) findViewById(R.id.drag_drop_4_prompt);
	...
	OnItemLongClickListener myOnItemLongClickListener = new OnItemLongClickListener() {
		...
		public boolean onItemLongClick(AdapterView<?> parent, View view,
			...
			ItemsListAdapter associatedAdapter = (ItemsListAdapter) (parent
					.getAdapter());
	...
	OnDragListener myOnDragListener = new OnDragListener() {
		...
		public boolean onDrag(View v, DragEvent event) {
			...
			case DragEvent.ACTION_DROP:
				...
				ItemsListAdapter srcAdapter = (ItemsListAdapter) (oldParent
						.getAdapter());

				LinearLayoutListView newParent = (LinearLayoutListView) v;
				ItemsListAdapter destAdapter = (ItemsListAdapter) (newParent.listView
						.getAdapter());
	...
	class ItemOnDragListener implements OnDragListener {
		...
		public boolean onDrag(View v, DragEvent event) {
			...
			case DragEvent.ACTION_DROP:
				...
				ItemsListAdapter destAdapter = (ItemsListAdapter) (newParent
						.getAdapter());
				List<Item> destList = destAdapter.getList();
	...
	OnItemClickListener listOnItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			Toast.makeText(AndroidDragAndDrop4.this,
	...
	private void initItems() {
		...
		TypedArray arrayDrawable = getResources().obtainTypedArray(
				R.array.resicon);
