 ...
 */
@SuppressLint("NewApi")
public class AndroidDragAndDrop2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.phone_android_drag_drop2);
		targetLayout = (LinearLayout) findViewById(R.id.drag_drop2_targetlayout);
		listSource = (ListView) findViewById(R.id.drag_drop2_sourcelist);
		
		listTarget = (ListView) findViewById(R.id.drag_drop2_targetlist);
		
		comments = (TextView) findViewById(R.id.drag_drop2_comments);
