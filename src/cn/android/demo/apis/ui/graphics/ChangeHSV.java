 ...
 * 
 */
public class ChangeHSV extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ui_graphics_change_hsv);
		...
		String onLineImgSource = "http://img2.imgtn.bdimg.com/it/u=685359157,1269566533&fm=21&gp=0.jpg";
	...
	OnClickListener buttonProcessOnClickListener = new OnClickListener() {
	...
	OnClickListener buttonResetOnClickListener = new OnClickListener() {
	...
	private class MyNetworkTask extends AsyncTask<URL, Void, Bitmap> {
		...
		protected Bitmap doInBackground(URL... urls) {
			...
			Bitmap shrinkedBitmap = Bitmap.createScaledBitmap(networkBitmap,
					networkBitmap.getWidth() / 2,
					networkBitmap.getHeight() / 2, false);
	...
	private GroupBitmap convertColorHSVColor(Bitmap src) {
		...
		/*
		 * pixelHSV[0] : Hue (0 .. 360) pixelHSV[1] : Saturation (0...1)
		...
		convertedGroupBitmap.bitmapHue = Bitmap.createBitmap(mapHue, w, h,
				Config.RGB_565);
		convertedGroupBitmap.bitmapSat = Bitmap.createBitmap(mapSat, w, h,
				Config.RGB_565);
		convertedGroupBitmap.bitmapVal = Bitmap.createBitmap(mapVal, w, h,
				Config.RGB_565);
