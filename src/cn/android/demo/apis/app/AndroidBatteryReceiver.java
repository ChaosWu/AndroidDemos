...
public class AndroidBatteryReceiver extends BroadcastReceiver {
	@Override
	public void onReceive(Context context, Intent intent) {
		Log.v("DDD", "AndroidBatteryReceiver");
		...
		int status;
		/*
		 * advised in Android doc: http://goo.gl/xYemvi but in my test on Nexus
		 * 7 WiFi (2012) Android 5.1 status always return -1
		 */
